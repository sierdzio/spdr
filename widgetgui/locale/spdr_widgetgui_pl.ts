...
<context>
    <name>SpdrGuiBasicInputForm</name>
    <message>
...
Symulacja może służyć do sprawdzenia, czy Spdr działa poprawnie, bez ryzykowania zmiany danych na dysku. Najlepiej połączyć symulację z ustawieniem wysokiego poziomu logowania.</translation>
    ...
    <message>
        ...
        <source>Use this control to specify what should be done when Spdr encounters an already existing file with the same name present in output. If files are identical, Spdr will simply skip that file. But if the contents are different, &lt;b&gt;Update mode&lt;/b&gt; will kick in:
